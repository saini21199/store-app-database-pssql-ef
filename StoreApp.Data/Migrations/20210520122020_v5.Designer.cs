            ...
            modelBuilder.Entity("SamuraiApp.Domain.PurchaseOrder", b =>
                {
                    ...
                    b.Property<int?>("supplierssupplier_id")
                        .HasColumnType("integer");

                    b.Property<string>("supply_date")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("supplierssupplier_id");
            ...
            modelBuilder.Entity("SamuraiApp.Domain.PurchaseOrder", b =>
                {
                    ...
                    b.HasOne("SamuraiApp.Domain.Supplier", "suppliers")
                        .WithMany()
                        .HasForeignKey("supplierssupplier_id");
                });
